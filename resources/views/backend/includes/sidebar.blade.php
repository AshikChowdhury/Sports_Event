    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if ($logged_in_user->isAdmin())
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/setup*'), 'open') }}">
                    <a class="nav-link nav-dropdown-toggle" href="#">
                        <i class="icon-settings"></i> Setup
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/setup/events*')) }}"
                               href="{{ route('admin.setup.events.index') }}"> Events
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/setup/teams*')) }}"
                               href="{{ route('admin.setup.teams.index') }}"> Teams
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/setup/sponsors*')) }}"
                               href="{{ route('admin.setup.sponsors.index') }}"> Sponsors
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/setup/matches*')) }}"
                               href="{{ route('admin.setup.matches.index') }}"> Matches
                            </a>
                        </li>
                    </ul>
                </li>
