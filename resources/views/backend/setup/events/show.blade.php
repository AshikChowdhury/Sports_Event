            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li>
                            <a class="nav-link" data-toggle="tab" href="#schedules" role="tab"
                               aria-controls="overview" aria-expanded="true"><i
                                        class="fa fa-clock-o "></i> Schedules
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="schedules" role="tabpanel" aria-expanded="true">
                            @include('backend.setup.events.show.tabs.schedule')
                        </div><!--tab-->
                    </div><!--tab-content-->
                </div><!--col-->
            </div><!--row-->
