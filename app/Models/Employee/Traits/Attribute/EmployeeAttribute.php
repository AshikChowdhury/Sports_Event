...
namespace App\Models\Employee\Traits\Attribute;
...
trait EmployeeAttribute
{
    ...
    {
        return '<a href="' . route('admin.setup.events.show', $this) . '" class="btn btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.view') . '"></i></a>';
    }
    ...
    {
        return '<a href="' . route('admin.setup.events.edit', $this) . '" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
    }
