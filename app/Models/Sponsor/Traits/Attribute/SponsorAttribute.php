...
namespace App\Models\Sponsor\Traits\Attribute;
...
trait SponsorAttribute
{
    ...
    {
        return '<a href="' . route('admin.setup.sponsors.show', $this) . '" class="btn btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.view') . '"></i></a>';
    }
    ...
    {
        return '<a href="' . route('admin.setup.sponsors.edit', $this) . '" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
    }
    ...
    public function getStatusButtonAttribute()
    {
            switch ($this->status) {
                case 0:
                    return '<a href="' . route('admin.setup.sponsors.mark', [
                            $this,
                            1,
