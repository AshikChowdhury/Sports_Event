...
namespace App\Models\Team\Traits\Attribute;
...
trait TeamAttribute
{
    ...
    {
        return '<a href="' . route('admin.setup.teams.show', $this) . '" class="btn btn-info"><i style="margin-top: 5px" class="fa fa-search" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.view') . '"></i></a>';
    }


    public function getShowMemberButtonAttribute()
    {
        return '<a href="' . route('admin.setup.members.index', $this) . '" class="btn btn-info"><i style="margin-top: 5px" class="fa fa-users" data-toggle="tooltip" data-placement="top" title="Member"></i></a>';
    }
    ...
    {
        return '<a href="' . route('admin.setup.teams.edit', $this) . '" class="btn btn-primary"><i style="margin-top: 5px" class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
    }
